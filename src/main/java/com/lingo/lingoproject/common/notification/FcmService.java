package com.lingo.lingoproject.common.notification;
...
import com.lingo.lingoproject.common.notification.dto.GetNotificationResponseDto;
import com.lingo.lingoproject.common.notification.dto.SaveFcmTokenRequestDto;
import com.lingo.lingoproject.db.repository.FailedFcmMessageLogRepository;
import com.lingo.lingoproject.db.repository.FcmTokenRepository;
import com.lingo.lingoproject.db.repository.NotificationOptionOutUserRepository;
import com.lingo.lingoproject.db.repository.NotificationRepository;
import com.lingo.lingoproject.common.retry.FcmRetryQueueService;
...
public class FcmService {
  ...
  public void sendFcmNotification(User receiver, String title, String body, NotificationType type) {
    ...
    notificationRepository.save(com.lingo.lingoproject.db.domain.Notification
        .builder()
            .user(receiver)
            .type(type)
            .title(title)
  ...
  public List<GetNotificationResponseDto> getNotificationMessage(User user){
    List<com.lingo.lingoproject.db.domain.Notification> notifications = notificationRepository.findAllByUser(user);

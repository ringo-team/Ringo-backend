...
import com.lingo.lingoproject.api.match.dto.GetMatchingRequestMessageResponseDto;
...
import com.lingo.lingoproject.api.match.dto.RequestMatchingResponseDto;
...
public class MatchController implements MatchingApi {
  ...
  public ResponseEntity<?> requestMatching(MatchingRequestDto matchingRequestDto, @AuthenticationPrincipal User user) {
    ...
    log.info("""
        ...
        """, matchingRequestDto.requestId(), matchingRequestDto.requestedId());

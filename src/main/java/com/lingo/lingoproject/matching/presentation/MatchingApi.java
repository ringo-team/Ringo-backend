...
public interface MatchingApi {
  ...
  @PatchMapping("/users/{user-id}/click")
  ResponseEntity<ResultMessageResponseDto> updateProfileClickCount(@PathVariable(value = "user-id") Long userId, @AuthenticationPrincipal User user);
}
